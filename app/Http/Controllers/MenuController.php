...
class MenuController extends Controller
{
    ...
    public function getAllMenu(){
        $menu = DB::table('menu')
            ...
            ->select('menu.id as menuId', 'restaurants.id','restaurants.restaurantName','restaurants.address','barangay.barangayName','menu.menuName', 'categories.categoryName', 'menu.imagePath')->get();
