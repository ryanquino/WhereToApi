...
class MenuController extends Controller
{
    ...
    public function getAllMenu(){
        $menu = DB::table('menu')
            ...
            ->select('DISTINCT(menu.id) as menuId', 'restaurants.id as restaurantId','restaurants.restaurantName','restaurants.address','barangay.barangayName','menu.menuName', 'categories.categoryName', 'menu.imagePath')
            ->get();
