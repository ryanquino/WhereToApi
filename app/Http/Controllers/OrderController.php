...
class OrderController extends Controller
{
    ...
    public function getTransactionDetails(){
        $details = DB::table('transactions')
            ...
            ->select('transactions.id','users.name', 'users.contactNumber','restaurants.restaurantName','barangay.barangayName','transactions.deliveryAddress', 'transactions.created_at', 'notification_device.deviceId', 'transactions.riderId', 'transactions.status', 'transactions.deliveryCharge')
    ...
    public function getTransactionDetailsById($id){
        $details = DB::table('transactions')
            ...
            ->join('notification_device', 'users.id', '=', 'notification_device.userId')
            ->join('barangay', 'barangay.id', '=', 'transactions.barangayId')
            ->select('transactions.id','users.name', 'users.contactNumber', 'barangay.barangayName','restaurants.restaurantName','transactions.deliveryAddress','transactions.created_at', 'notification_device.deviceId', 'transactions.riderId', 'transactions.status', 'transactions.deliveryCharge')
